...
if __name__=="__main__":
    ...
    file_wide=TFile("FinalPlotDM_V/grFinal_PFDMV-q_qPrime-widewithNarrow-limit_35p9fb.root")
    ...
    if isGQ:
        ...
        if isLogx:
            canvas.SaveAs("wide_gqprime-withNarrow-limit_35p9fb_logx.pdf")
        else:
            canvas.SaveAs("wide_gqprime-withNarrow-limit_35p9fb.pdf")
